...
void sharaq12_FastBeam(int a = 0, int b = 100000, int frun = 1, int lrun = 2)
{
	...
	TFile *file = new TFile("/u/ddas/software/work/artemis-oedo/output/optics24/chks1alloptics0089.root"); // for 2024 run FastBeam
	...
	TFile *ofile_new = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/opticsOutput/FastBeam_0089_2024.root", "recreate"); // for 2024 run FastBeam
	...
	TFile *ofile = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/opticsOutput/FastBeam_0089_2024_histos.root", "recreate"); // for lxpool artemis installation
