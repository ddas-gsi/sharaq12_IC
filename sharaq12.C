...
// void sharaq12(int a = 440574, int b = 440577,int frun = 65, int lrun = 66)
{
	...
	// TFile *file = new TFile("/u/ddas/software/work/artemis-oedo/output/phys24/all24physics1008.root");

	string inputfile = "/u/ddas/software/work/artemis-oedo/output/phys24/all24physics" + RUN_Nbr + ".root";
	...
	// TFile *ofile_new = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/24sharaq12phys_1008new.root", "recreate");
	string outputFile = "/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/24sharaq12phys_" + RUN_Nbr + "new.root";
		...
		for (int k = 0; k < array_S11_y_cal->GetEntries() && k < SRPPAC_max_ion; k++)
		  {
			...
			p_S11_t = (TTimingChargePositionData*) array_S11_y_cal->At(k);//Apaño
		...
		for (int k = 0; k < array_S12_x_cal->GetEntries() && k < SRPPAC_max_ion; k++)
		  {
			...
			p_S12_t = (TTimingChargePositionData*) array_S12_x_cal->At(k);//Apaño
	...
	// TFile *ofile = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/24sharaq12physhistos_1008.root", "recreate");
	...
	string outputHist = "/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/24sharaq12physhistos_" + RUN_Nbr + ".root";
	TFile *ofile = new TFile(outputHist.c_str(), "recreate");
	hlist->Write();
	ofile->Close();
	ofile_new->cd();
