...
void reverse_sharaq12_ICAnalysis_1event()
{
    ...
    TCutG *cut50Ca20FE9 = (TCutG *)gROOT->FindObject("FE9pidCut_50Ca_1053_2024");
    TCutG *S1cut = (TCutG *)gROOT->FindObject("s1pidCut_50Ca20_1053_2024");
    ...
    // for (int i = 0; i < entries; i++)
    {
        // tree->GetEntry(i);
        // int eventNbr = 506573;
        // int eventNbr = 554959; // of 1005 file
        // int eventNbr = 10; // of 902_All.root

        int eventNbr = 300786; // of 24sharaq12phys_1053new.root
        // int eventNbr = 889022; // of 24sharaq12phys_1053new.root
        // int eventNbr = 1443121; // of 24sharaq12phys_1053new.root
        ...
        // if (cut50Ca20FE9->IsInside(PID_T_0, FE9_X_0))
    ...
    c1->cd(8);
    // h_IC_E_Cal_2Dcut->Draw("colz");  // Remove colz if you don't want color palette
    h_IC_E_2Dcut->SetLineColor(kBlack);
    h_IC_E_2Dcut->SetMarkerColor(kBlack);
    h_IC_E_2Dcut->SetFillColor(0); // Remove fill color if it's affecting visibility
    h_IC_E_2Dcut->Draw("BOX");     // "BOX" ensures it is drawn as a 2D histogram
    graph->Draw("P SAME");

    c1->cd(9);
    // h_IC_E_Cal_UpdatedC_2Dcut->Draw("colz");  // Remove colz if you don't want color palette
    h_IC_E_Cal_2Dcut->SetLineColor(kBlack);
    h_IC_E_Cal_2Dcut->SetMarkerColor(kBlack);
    h_IC_E_Cal_2Dcut->SetFillColor(0); // Remove fill color
