...
def deltaLISES1Y_correction_function(x, *par):
    y = par[0] + par[1]*x
    return y

def deltaLISES1Y_correction_factor(x, *par):
    dy = fn_delta150(x) - deltaLISES1Y_correction_function(x, *par)
    return dy
...
print(f"Copying the root file {RUN_Nbr}_Analysis_2024.root to the rangeCorrection folder ...")
# os.system(f"cp /u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/{RUN_Nbr}_Analysis_2024.root /u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/{RUN_Nbr}_Analysis_2024.root")
os.system(f"cp /u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/{RUN_Nbr}_Analysis_2024.root /u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/{RUN_Nbr}_Analysis_2024_new1404.root")
...
# rootFile = ROOT.TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/1055_Analysis_2024.root", "UPDATE")
# inputFile = f"/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/{RUN_Nbr}_Analysis_2024.root"
inputFile = f"/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/{RUN_Nbr}_Analysis_2024_new1404.root"
...
c1 = ROOT.TCanvas("c1", "c1", 2500, 1800)
c1.Divide(5,5)
...
# paramsDeltaLISES1Y = (133.716, 0.0710492)

paramsS1Y = (39.0777, -0.044497, -0.000276438, -2.69948e-07)                                # As per corrections of 14.04.2025
paramsS1X = (39.4342, -0.0391016, -0.000230836, -6.49512e-07, 2.34539e-08, 1.49169e-10)     # As per corrections of 14.04.2025
paramsBetaS1 = (-693.042, 4793.25)                                                          # As per corrections of 14.04.2025
paramsDeltaS1Y = (148.124, 0.0908313)                                                       # As per corrections of 14.04.2025
paramsDeltaLISES1Y = (130.231, 0.0700098)                                                   # As per corrections of 14.04.2025
...
h_rangeCa_st_corrected = ROOT.TH2F("rangeCa_corrected_by_Straight_Line", "rangeCa Corrected by Straight Line:betaS1; betaS1; rangeCa Corrected", 1000, 0.15, 0.19, 1000, 0, 800)
h_rangeCa_lise_corrected = ROOT.TH2F("rangeCa_corrected_by_LISE", "rangeCa Corrected by LISE:betaS1; betaS1; rangeCa Corrected", 1000, 0.15, 0.19, 1000, 0, 800)
...
h_rangeAll_st_corrected = ROOT.TH2F("rangeAll_corrected_by_Straight_Line", "rangeAll Corrected by Straight Line:betaS1; betaS1; rangeAll Corrected", 1000, 0.15, 0.19, 1000, 0, 800)
h_rangeAll_lise_corrected = ROOT.TH2F("rangeAll_corrected_by_LISE", "rangeAll Corrected by LISE:betaS1; betaS1; rangeAll Corrected", 1000, 0.15, 0.19, 1000, 0, 800)
...
h1D_rangeAll_st = ROOT.TH1F("h1D_rangeAll_st", "rangeAll_st->deltaAll_st*betaS1^2*100; rangeAll_st", 1000, 0, 800)
...
h2D_deltaAll_st_vs_S1Y = ROOT.TH2F("h2D_deltaAll_st_vs_S1Y", "deltaAll_st vs S1_Y_0; S1_Y_0; deltaAll_st", 1000, -150, 150, 1000, 0, 300)
hlist.Add(h2D_deltaAll_st_vs_S1Y)
...
h1D_deltaCa_liseS1Y = ROOT.TH1F("h1D_deltaCa_liseS1Y", "deltaCa_liseS1Y; deltaCa_liseS1Y", 1000, 0, 300)
hlist.Add(h1D_deltaCa_liseS1Y)
h1D_deltaAll_liseS1Y = ROOT.TH1F("h1D_deltaAll_liseS1Y", "deltaAll_liseS1Y; deltaAll_liseS1Y", 1000, 0, 300)
hlist.Add(h1D_deltaAll_liseS1Y)

h2D_deltaAll_liseS1Y_vs_S1Y = ROOT.TH2F("h2D_deltaAll_liseS1Y_vs_S1Y", "deltaAll_liseS1Y vs S1_Y_0; S1_Y_0; deltaAll_liseS1Y", 1000, -150, 150, 1000, 0, 300)
hlist.Add(h2D_deltaAll_liseS1Y_vs_S1Y)
h2D_deltaAll_liseS1Y_vs_betaS1 = ROOT.TH2F("h2D_deltaAll_liseS1Y_vs_betaS1", "deltaAll_liseS1Y vs betaS1; betaS1; deltaAll_liseS1Y", 1000, 0.15, 0.19, 1000, 0, 300)
hlist.Add(h2D_deltaAll_liseS1Y_vs_betaS1)


# PID 
h_peakS1YCa_deltaCa_st = ROOT.TH2F("peakS1YCa_deltaCa_st", "peakS1YCa:deltaCa_st; deltaCa_st; peakS1YCa", 1000, 0, 300, 1000, 0, 70)
h_peakS1YXCa_deltaCa_st = ROOT.TH2F("peakS1YXCa_deltaCa_st", "peakS1YXCa:deltaCa_st; deltaCa_st; peakS1YXCa", 1000, 0, 300, 1000, 0, 70)
h_peakS1YCa_deltaCa_lise = ROOT.TH2F("peakS1YCa_deltaCa_lise", "peakS1YCa:deltaCa_lise; deltaCa_lise; peakS1YCa", 1000, 0, 300, 1000, 0, 70)
h_peakS1YXCa_deltaCa_lise = ROOT.TH2F("peakS1YXCa_deltaCa_lise", "peakS1YXCa:deltaCa_lise; deltaCa_lise; peakS1YXCa; ", 1000, 0, 300, 1000, 0, 70)

h_peakS1YAll_deltaAll_st = ROOT.TH2F("peakS1YAll_deltaAll_st", "peakS1YAll:deltaAll_st; deltaAll_st; peakS1YAll", 1000, 0, 300, 1000, 0, 70)
h_peakS1YXAll_deltaAll_st = ROOT.TH2F("peakS1YXAll_deltaAll_st", "peakS1YXAll:deltaAll_st; deltaAll_st; peakS1YXAll", 1000, 0, 300, 1000, 0, 70)
h_peakS1YAll_deltaAll_lise = ROOT.TH2F("peakS1YAll_deltaAll_lise", "peakS1YAll:deltaAll_lise; deltaAll_lise; peakS1YAll", 1000, 0, 300, 1000, 0, 70)
h_peakS1YXAll_deltaAll_lise = ROOT.TH2F("peakS1YXAll_deltaAll_lise", "peakS1YXAll:deltaAll_lise; deltaAll_lise; peakS1YXAll", 1000, 0, 300, 1000, 0, 70)
...
deltaCa_liseS1Y = np.zeros(1, dtype=np.float64)     # deltaCa correction for S1_Y_0
deltaAll_liseS1Y = np.zeros(1, dtype=np.float64)    # deltaAll correction for S1_Y_0
...
deltaCa_liseS1Y_branch = tree.Branch("deltaCa_liseS1Y", deltaCa_liseS1Y, "deltaCa_liseS1Y/D")   # /D for double..
deltaAll_liseS1Y_branch = tree.Branch("deltaAll_liseS1Y", deltaAll_liseS1Y, "deltaAll_liseS1Y/D")   # /D for double..
...
for i_Event in range(num_entries):        
    ...
    deltaCa_stS1Y[0] = -1000000
    deltaAll_stS1Y[0] = -1000000
    deltaCa_liseS1Y[0] = -1000000
    deltaAll_liseS1Y[0] = -1000000
...
#     betaS1[0] = calculateBeta(S1PID_T_0 - 434.060, distance_FE12_S1)     # -434.060 ns is the TOF offset for S1PID_T_0
    ...
    if (peakAll>0):   
        ...
        h2D_deltaAll_st_vs_S1Y.Fill(S1_Y_0, deltaAll_st[0])
        ...
        # deltaCa_stS1Y[0] = deltaS1Y_correction_factor(S1_Y_0, *paramsDeltaS1Y) + rangeBetaS1_correction_factorStraight(betaS1_0, *paramsBetaS1) + rangeCa/(betaS1_0**2)/100
        # deltaAll_stS1Y[0] = deltaS1Y_correction_factor(S1_Y_0, *paramsDeltaS1Y) + rangeBetaS1_correction_factorStraight(betaS1_0, *paramsBetaS1) + rangeAll/(betaS1_0**2)/100
        ...
        deltaCa_liseS1Y[0] = deltaLISES1Y_correction_factor(S1_Y_0, *paramsDeltaLISES1Y) + deltaCa_lise[0]
        deltaAll_liseS1Y[0] = deltaLISES1Y_correction_factor(S1_Y_0, *paramsDeltaLISES1Y) + deltaAll_lise[0]
        h1D_deltaCa_liseS1Y.Fill(deltaCa_liseS1Y[0])
        h1D_deltaAll_liseS1Y.Fill(deltaAll_liseS1Y[0])
        h2D_deltaAll_liseS1Y_vs_S1Y.Fill(S1_Y_0, deltaAll_liseS1Y[0])
        h2D_deltaAll_liseS1Y_vs_betaS1.Fill(betaS1_0, deltaAll_liseS1Y[0])
        ...
        h_peakS1YCa_deltaCa_st.Fill(deltaCa_st[0], peakS1YCa[0])
        h_peakS1YXCa_deltaCa_st.Fill(deltaCa_st[0], peakS1YXCa[0])
        h_peakS1YCa_deltaCa_lise.Fill(deltaCa_lise[0], peakS1YCa[0])
        h_peakS1YXCa_deltaCa_lise.Fill(deltaCa_lise[0], peakS1YXCa[0])

        h_peakS1YAll_deltaAll_st.Fill(deltaAll_st[0], peakS1YAll[0])
        h_peakS1YXAll_deltaAll_st.Fill(deltaAll_st[0], peakS1YXAll[0])
        h_peakS1YAll_deltaAll_lise.Fill(deltaAll_lise[0], peakS1YAll[0])
        h_peakS1YXAll_deltaAll_lise.Fill(deltaAll_lise[0], peakS1YXAll[0])
    ...
    deltaCa_liseS1Y_branch.Fill()
    deltaAll_liseS1Y_branch.Fill()
...
c1.cd(19)
h2D_deltaAll_st_vs_S1Y.Draw("colz")
...
c1.cd(22)
h1D_deltaCa_liseS1Y.Draw()

c1.cd(23)
h1D_deltaAll_liseS1Y.Draw()

c1.cd(24)
h2D_deltaAll_liseS1Y_vs_S1Y.Draw("colz")

c1.cd(25)
h2D_deltaAll_liseS1Y_vs_betaS1.Draw("colz")
...
# histFile = ROOT.TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/1055_histFile_2024.root", "RECREATE")
# histFile = ROOT.TFile(f"/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/{RUN_Nbr}_histFile_2024.root", "RECREATE")
histFile = ROOT.TFile(f"/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/{RUN_Nbr}_histFile_2024_new1404.root", "RECREATE")
c1.Write()
hlist.Write("HistogramList", ROOT.TObject.kSingleKey)
histFile.Close()
