...
// This is to run after running sharaq12.C script

void analyzer(int fEvent = 0, int lEvent = 1)
{

  // TFile *file = new TFile("/home/jupiter/test/work/artemis-oedo/output/Analysis/testgood.root","");
  // TFile *file = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/24sharaq12phys_1053new.root", "");
  TFile *file = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/1053_Analysis_2024.root", "");
  // TFile *file = new TFile("Files/F3DS.root","");
  // TFile *file = new TFile("/home/carlos/data/RootFiles/sharaq12good.root","");
  ...
  ***************************/
  ...
  // TFile *ofile_new = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/24sharaq12phys_1053new_AoQ.root", "recreate");

  TFile *ofile_new = new TFile("/u/ddas/software/work/artemis-oedo/output/Analysis/physOutput/outputRange/rangeCorrection/1053_Analysis_2024_AoQ.root", "recreate");
  TTree *tree_new = new TTree("tree_new", "Good events sharaq12");
