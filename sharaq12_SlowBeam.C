	...
	for (int i = a; i < b; i++)
	{
		...
		***********************************/
		...
		for (int j = 0; j < 30; j++)
		{
			...
			// IC_E_Cal[j] = IC_E[j] * scalingFactor2024[j]; // Energy calibrated by Scaling factor
...
double f_SRPPAC_gain(int a, int b, int c)
{
	...
	if (a == 0)
	{
		...
		// string input = "/u/ddas/software/work/artemis-oedo/macro/Analysis/SRPPAC_param2024/" + SRPPAC + "_v.txt"; // for lxpool artemis installation
	...
	if (a == 1)
	{
		...
		// string input = "/u/ddas/software/work/artemis-oedo/macro/Analysis/SRPPAC_param2024/" + SRPPAC + "_h.txt"; // for lxpool artemis installation
		myfile = fopen(input.c_str(), "r");
...
double f_SRPPAC_gain2(int o, int a, int b, int c)
{
	...
	if (o == 1)
	{
		...
		// string input = "/u/ddas/software/work/artemis-oedo/macro/Analysis/SRPPAC_param22024/" + SRPPAC + "_h_" + Form("%d", a) + ".txt"; // for lxpool artemis installation
		myfile = fopen(input.c_str(), "r");
		for (j = 0; j < HEIGHT_H; j++)
		{
			for (k = 0; k < WIDTH; k++)
	...
	if (o == 0)
	{
		...
		// string input = "/u/ddas/software/work/artemis-oedo/macro/Analysis/SRPPAC_param22024/" + SRPPAC + "_v_" + Form("%d", a) + ".txt"; // for lxpool artemis installation
		// cout << input << endl;
		myfile = fopen(input.c_str(), "r");
		for (j = 0; j < HEIGHT_V; j++)
		{
